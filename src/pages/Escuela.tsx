  ...
  const renderContent = () => {
    switch (activeSection) {
      case "intro":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">Introducción</h3>
      ...
      case "aprendizaje":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">Aprendizaje</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "que-aprenden":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">¿Qué aprenden?</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "como-aprenden":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">¿Cómo aprenden?</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "actividades":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">Actividades</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "acompanamiento":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">Acompañamiento</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "equipo":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">El equipo</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "familias":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">Las familias</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "ninos":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">Los niños y niñas</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "etapas":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">Etapas y espacios</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "cerezos":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">De 3 a 6 años; Cirerers</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
      ...
      case "ginesta":
        return (
          <div className="space-y-6">
            <h3 className="font-handscript text-[#43362A] text-xl xl:text-2xl 2xl:text-3xl font-bold">De 6 a 12 años; Ginesta y Arbreda</h3>
            <p className="font-handscript text-[#43362A] text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-justify">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4 w-full">
            <div className="bg-white/20 rounded-lg p-4 sticky top-4">
              <h2 className="font-handscript text-[#43362A] text-xl font-bold mb-4">Secciones</h2>
              <nav className="space-y-2">
                {menuItems.map((item) => (
                  <button
                    key={item.id}
                    onClick={() => setActiveSection(item.id)}
                    className={`w-full text-left px-3 py-2 rounded transition-all duration-300 font-handscript ${
                      activeSection === item.id
                        ? 'bg-[#43362A] text-white'
                        : 'text-[#43362A] hover:bg-white/30'
                    }`}
                  >
                    {item.title}
                  </button>
