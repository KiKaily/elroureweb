      ...
      <section className="flex flex-col items-center w-full max-w-[90vw] 2xl:max-w-[1200px] mt-10">
        ...
        <div className="w-full max-w-[800px] space-y-16">
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
            ...
            <p className="font-montserrat text-stone-100 text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-left mb-8">
              Me dedico al acompañamiento a madres, padres y profesionales a partir de las diferentes situaciones y dificultades cotidianas que conlleva la relación con niñas, niños y adolescentes.
            </p>
            <p className="font-montserrat text-stone-100 text-lg xl:text-xl 2xl:text-2xl leading-relaxed text-left mb-8">
              Por otra parte facilito formaciones adaptadas a las necesidades de colectivos educativos interesados en el enfoque de la educación viva y la comunicación consciente.
            </p>
          </div>
